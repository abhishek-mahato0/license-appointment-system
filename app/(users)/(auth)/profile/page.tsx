...
export default function page() {
  ...
  const { id, citizenship_id, license_id } = JSON.parse(
  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      citizenship_id !== "none" && getDocumentInformation();
      license_id !== "none" && getLicenseInformation();
    }
  }, [id]);
  return (
          ...
          <div className=" w-full items-center flex justify-end gap-4">
            {Object.keys(citizenshipInformation).length > 0 && (
              <>
                ...
                />
                <CitimageEditForm citizenshipImages={citizenshipInformation} />
              </>
            )}
          </div>
          <div className="grid grid-cols-3 gap-3 items-center justify-between w-full px-3 py-2">
            ...
            <>
              <div className=" w-full items-center flex justify-end gap-3">
                {Object.keys(licenseInformation).length > 0 && (
                  <>
                    <LicenseEditForm licenseInformation={licenseInformation} />
                    <LicimageEditForm licenseInformation={licenseInformation} />
                  </>
                )}
              </div>
              <div className="grid grid-cols-3 gap-3 items-center justify-between w-full px-3 py-2">
